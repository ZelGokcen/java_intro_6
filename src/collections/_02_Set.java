...
public class _02_Set {
    public static void main(String[] args) {
        ...
        3. TreeSet
               ...
               - It does not allow duplicates
               - It DOES NOT ALLOW any null element as it does not know how to sort it
               with numbers and strings when the element is null
         */
    System.out.println("\n----------HashSet---------\n");
...
/*
- if my data has duplicates then i would use list
- if it is synchornized then you would use vector
- if there are no duplicates then i would use set
- if we change size a lot then we use linkedList
- if we sort the data then we use TreeSet
- if we do not sort the data then we use hashset or linkedHashSet
- if we keep insertion order then we use linkedHashSet
- if we do not keep insertion order then we use hashset
 */